...
int binarySearch_withCondtion(int *array, int arraySize, int target);
...
int main(void)
{
    ...
    //找出該數在第幾個index
    cout << "no condtion case:" << binarySearch(arr, ARRAY_SIZE(arr), 200);
    ...
    int arr2[8] = {1, 2, 2, 2, 2, 2, 3, 3};
    cout << "with condition case:" << binarySearch_withCondtion(arr2, ARRAY_SIZE(arr2), 2);
